...
const ROLES = [
  ...
  },
  {
    ...
    label: "For Investor",
    badge: "Impact",
    badgeColor: "rgba(239,159,39,0.15)",
    badgeText: "#ef9f27",
    ...
    cta: "View Platform",
    ctaColor: "#ef9f27",
    ctaBg: "rgba(239,159,39,0.1)",
    ctaBorder: "rgba(239,159,39,0.25)",
    href: "#impact",
    accent: "#ef9f27",
    accentBg: "rgba(239,159,39,0.06)",
    accentBorder: "rgba(239,159,39,0.15)",
    features: [
